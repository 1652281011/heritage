...
import os
import re
from flask import app, g, request, current_app, make_response
from app.view.base import base_view
from app.utils.uploader import Uploader


# 富文本编辑器upload 上传文件  https://segmentfault.com/a/1190000002429055/  文档地址：http://fex-team.github.io/ueditor/
@base_view.route('/admin/rich-text/', methods=['GET', 'POST', 'OPTIONS'])
def data_manage_news_upload():
    """UEditor文件上传接口
